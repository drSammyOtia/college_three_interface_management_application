...
def doRegistration(request):
    ...
    if not (email_id and password and confirm_password):
        messages.error(request, 'Please provide all above details!')
        return render(request, 'registration.html')
    ...
    if user_type is None:
        messages.error(request, 'Please use valid fromat for the email id: '<username>.<staff|student|hod>@<college_domain>'"))
        return render(request, 'registration.html')
